...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { Date: @inquiry.Date, Location: @inquiry.Location, Name: @inquiry.Name, Price: @inquiry.Price, Property: @inquiry.Property } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { Date: @inquiry.Date, Location: @inquiry.Location, Name: @inquiry.Name, Price: @inquiry.Price, Property: @inquiry.Property } }
